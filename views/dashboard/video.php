<!-- details -->
	<section class="section details">
		<!-- details background -->
		<div class="details__bg" data-bg="<?php echo asset_url(); ?>img/home/home__bg.jpg"></div>
		...
		<div class="container">
			<div class="row">
				<!-- title -->
				<div class="col-12">
					<h1 class="details__title"><?php echo $video_name['video_name']; ?></h1>
				</div>
				<!-- end title -->
							...
							<div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-7">
								<div class="card__content">
									<div class="card__wrap">
										<span class="card__rate"><i class="icon ion-ios-star"></i><?php echo $video_rate['video_rate']; ?></span>

										<ul class="card__list">
											<li>HD</li>
											<li>16+</li>
											<?php if($free){ ?>
											<li style = "background-color: rgb(81, 187, 94); color: rgb(55, 103, 98);" ><?php echo $free; ?></li>
											<?php } ?>
											<?php if($premium){ ?>
											<li style = "background-color: rgb(179, 64, 29); color: rgb(230, 203, 203);"><?php echo $premium; ?></li>
											<?php } ?>
											<?php if($cinematic){ ?>
											<li style = "background-color: rgb(167, 4, 4); color: rgb(234, 199, 199);"><?php echo $cinematic; ?></li>
											<?php } ?>
											<?php if($chain){ ?>
											<i class="fa fa-chain" style="font-size: 24px;color: rgb(152, 77, 77);position: relative;top: 0px;"></i>
											<?php } ?>
										</ul>
									</div>
									...
									<ul class="card__meta">
										<li>
											<span>Genre:</span> 
											<a href="#"><?php echo $video_category['video_category']; ?></a>
											<!-- <a href="#">Triler</a> -->
										</li>
										<li>
									...
									<div class="card__description card__description--details">
										<?php echo $video_description['video_description']; ?>
									</div>
								</div>
							</div>
							<!-- end card content -->
				...
				<div class="col-12 col-xl-6">
					...
					<!-- </video> -->
					<!-- https://ia800504.us.archive.org/31/items/Sintel-ThirdOpenMovieByBlenderFoundation/sintel-640-stereo.mp4 -->
					<!-- https://archive.org/download/BigBuckBunny_124/Contenst/big_buck_bunny_720p_surround.mp4 -->
					<!-- poster="https://cdn.windowsreport.com/wp-content/uploads/2017/04/YouTube-pauses-video-at-the-start-886x590.png" -->
					<!-- https://ia800504.us.archive.org/31/items/Sintel-ThirdOpenMovieByBlenderFoundation/sintel-640-stereo.mp4 -->
					<!-- autoplay="autoplay" -->
					<!-- muted="muted" loop="loop" controls  -->
					<!-- style="width: 35em; height: 20em !important;" -->
					...
					<?php if($chain){ ?>
						...
						<span style = "position: relative; top: 10px; color: rgb(189, 98, 98);">Excuse me, you have to click the "PRICING PLAN" button in header and choose a plan, please!</span>
					<?php } ?>
					<?php if(!$chain){ ?>
						<video src="<?php echo $video_url['video_url']; ?>" id="player">
										...
										<ul class="comments__list">
											<li class="comments__item">
												<div class="comments__autor">
													<img class="comments__avatar" src="<?php echo asset_url(); ?>img/user.svg" alt="">
										...
										<ul class="reviews__list">
											<li class="reviews__item">
												<div class="reviews__autor">
													<img class="reviews__avatar" src="<?php echo asset_url(); ?>img/user.svg" alt="">
							...
							<div class="gallery" itemscope>
								<div class="row">
									...
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="<?php echo asset_url(); ?>img/gallery/project-1.jpg" itemprop="contentUrl" data-size="1920x1280">
