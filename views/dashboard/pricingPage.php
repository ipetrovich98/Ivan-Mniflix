		...
		<div class="container">
			<div class="row">
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="price">
						<form action="<?php echo base_url(); ?>price_plan/free" method="post" accept-charset="utf-8" style = "width: 100%;">
							...
							<button type = "submit" class = "price__btn">Choose Plan</button>
						</form>
					</div>
				</div>
				<!-- end price -->
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="price price--premium">
						<form action="<?php echo base_url(); ?>price_plan/premium" method="post" accept-charset="utf-8" style = "width: 100%;">
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="price">
						<form action="<?php echo base_url(); ?>price_plan/cinematic" method="post" accept-charset="utf-8" style = "width: 100%;">
